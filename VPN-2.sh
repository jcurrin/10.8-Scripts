...
#  VPN-2.sh
#  This is the current script for VPN installation used at my company.  This variation of the script takes the Computer name.  In our case is "Firstname Lastname"  It then modifies the computer name so that the VPN username looks like this "flastname"  So my computer name is "Joe Currin", therefore my username will appear "jcurrin"
#
#  Created by Joe Currin on 3/01/13.
#
